...
/**
 * Template Name: Integration Library
 *
 * @package DATABASICS
 */
...
<main id="primary" class="site-main">
	...
	<div class="library-wrap archive">
		...
		<div class="library-filters">
			...
			<?php if ($terms = get_terms('integration-library-type', [
				'orderby' => 'term_order',
				'order'   => 'ASC',
			])) : ?>

			<div class="library-list-filter-box category-group filter-card" data-filter="integration-library-type">
