...
<main id="primary" class="site-main">
	...
	<div class="library-wrap archive">
		...
		<div class="library-filters">
			...
			<?php if ($terms = get_terms('partner-type', [
				'orderby' => 'term_order',
				'order'   => 'ASC',
			])) : ?>

				<div class="library-list-filter-box category-group filter-card" data-filter="partner-type">
					<div class="library-filter-checkboxes">

						<?php foreach ($terms as $term) : ?>

							<div class="library-list-filter-box-checkbox">
								<input type="checkbox" name="partnerType-<?php echo $term->term_id; ?>" id="partnerType-<?php echo $term->term_id; ?>" value="<?php echo $term->term_id; ?>" data-tax="library-partnerType" class="category checkbox-<?php echo $term->slug; ?>">
								<label for="partnerType-<?php echo $term->term_id; ?>"><?php echo $term->name; ?></label>
							</div>
		...
		<div class="library-list">
			<div class="library-search">
				<form class="library-list-search" method="post" action="index.php">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="26" height="26" class="search-icon">
						<path d="M19.9 17.7l-5.5-5.6c.7-1.2 1.2-2.6 1.2-4.2 0-4.3-3.5-7.8-7.7-7.8C3.6.1.2 3.6.2 7.9s3.5 7.8 7.7 7.8c1.6 0 3.2-.5 4.4-1.4l5.4 5.5 2.2-2.1zM7.8 13.2c-2.9 0-5.2-2.4-5.2-5.3S5 2.6 7.8 2.6C10.7 2.6 13 5 13 7.9s-2.3 5.3-5.2 5.3z" fill-rule="evenodd" clip-rule="evenodd" fill="#00a0df" /></svg>
						...
						<div class="library-list-pagination-pages">
							<div class="pagination">
								<a href="#" data-page="" class="prev">
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 24" width="15" height="24">
										<path d="M12.2 0L15 2.8 5.7 12l9.3 9.2-2.8 2.8L0 12 12.2 0z" /></svg>
									Prev
								</a>
								<a href="#" data-page="" class="next">
									Next
									<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15 24" width="15" height="24">
										<path d="M2.8 24L0 21.2 9.3 12 0 2.8 2.8 0 15 12 2.8 24z" /></svg>
								</a>
							</div>
						</div>
					</div>
