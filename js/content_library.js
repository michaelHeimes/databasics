	...
	function PostsArchive() {
		...
		*/
		...
		this.getPosts = function () {
			var self = this;
			var url = localized.siteUrl + '/wp-json/databasics/v2/content_library';
		...
		this.displayPosts = function (posts) {
			...
			for (var i = 0; i < posts.length; i++) {
				...
				card +=     '<a class="trio-block-inner" href="' + posts[i].link + '">';
				card +=         '<div class="trio-block-photo">';
				card +=             '<img src="' + posts[i].photo + '" class="trio-image" alt="">';;
				card +=             posts[i].date;
				card +=         '</div>';
				card +=         '<div class="trio-block-content">';
				card +=             '<div class="trio-block-meta">';
				for (var x = 0; x < posts[i].solutions.length; x++) {
					card += '<span class="trio-block-meta-inner">' + posts[i].solutions[x] + '</span>';
				}
				card +=             '</div>';
