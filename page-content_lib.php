...
<main id="primary" class="site-main">
	...
	<div class="library-wrap archive">
		...
		<div class="library-filters">
			...
			<?php if ($terms = get_terms('content-library-type')) : ?>
			<div class="library-list-filter-box category-group filter-card" data-filter="content-library-type">
				<div class="library-filters-header">
					<h4 class="library-list-filter-box-title">Type</h4>
					<button type="button" class="library-list-filter-box-clear filter-button">Clear</button>
				</div>
				<div class="library-filter-checkboxes">
				<?php foreach ($terms as $term) : ?>
					<div class="library-list-filter-box-checkbox">
						<input type="checkbox" name="contentLibraryType-<?php echo $term->term_id; ?>" id="contentLibraryType-<?php echo $term->term_id; ?>" value="<?php echo $term->term_id; ?>" data-tax="library-contentLibraryType" class="category checkbox-<?php echo $term->slug; ?>">
						<label for="contentLibraryType-<?php echo $term->term_id; ?>"><?php echo $term->name; ?></label>
					</div>
			...
			<?php if ($terms = get_terms('content-library-solution')) : ?>
			<div class="library-list-filter-box category-group filter-card" data-filter="content-library-solution">
				<div class="library-filters-header">
					<h4 class="library-list-filter-box-title">Product/Solution</h4>
					<button type="button" class="library-list-filter-box-clear filter-button">Clear</button>
				</div>
				<div class="library-filter-checkboxes">
				<?php foreach ($terms as $term) : ?>
					...
					<div class="library-list-filter-box-checkbox">
						<input type="checkbox" name="contentLibrarySolution-<?php echo $term->term_id; ?>" id="contentLibrarySolution-<?php echo $term->term_id; ?>" value="<?php echo $term->term_id; ?>" data-tax="library-contentLibrarySolution" class="category checkbox-<?php echo $term->slug; ?>">
						<label for="contentLibrarySolution-<?php echo $term->term_id; ?>"><?php echo $term->name; ?></label>
					</div>
		...
		<div class="library-list">
			...
			<div class="archive-grid trio"></div>
